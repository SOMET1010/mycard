...
class EventsRepository {
  ...
  List<EventOverlay> get activeEvents =>
      _events.where((e) => e.isCurrentlyActive()).toList();
  ...
  List<EventOverlay> searchEvents(String query) {
    ...
    return _events
        .where(
          (event) =>
              event.label.toLowerCase().contains(lowerQuery) ||
  ...
  List<EventOverlay> filterByPeriod(String period) => _events
      .where((event) => event.period.toLowerCase() == period.toLowerCase())
      .toList();
