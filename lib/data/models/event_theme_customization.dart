...
class EventThemeCustomization {
  ...
  bool get showBackgroundPattern =>
      (layout['showBackgroundPattern'] as bool?) ?? false;
  String get backgroundPattern =>
      (layout['backgroundPattern'] as String?) ?? 'none';
  ...
  Map<String, dynamic> toJson() => {
    ...
    'colors': colors.map(
      (key, value) =>
          MapEntry(key, '#${value.value.toRadixString(16).substring(2)}'),
    ),
  ...
  @override
  String toString() =>
      'EventThemeCustomization(id: $id, name: $name, description: $description)';
}
