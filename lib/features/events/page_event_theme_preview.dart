...
class EventThemeCustomization {
  ...
  factory EventThemeCustomization.fromJson(Map<String, dynamic> json) =>
      EventThemeCustomization(
        ...
        secondaryColor: Color(
          int.parse('FF${json['secondaryColor']}', radix: 16),
        ),
        backgroundColor: Color(
          int.parse('FF${json['backgroundColor']}', radix: 16),
        ),
  ...
  Widget _buildBackgroundTab() => SingleChildScrollView(
    child: Column(
      ...
      children: [
        ...
        const SizedBox(height: 24),
        if (_themeCustomization.showBackgroundPattern) _buildPatternSelector(),
        const SizedBox(height: 24),
        ColorPickerField(
    ...
    if (mounted) {
      ...
      Navigator.pushReplacementNamed(
        ...
        arguments: {
          ...
          'customColors': {
            'primary': _themeCustomization.primaryColor.value.toRadixString(16),
            'secondary': _themeCustomization.secondaryColor.value.toRadixString(
              16,
            ),
            'accent': _themeCustomization.accentColor.value.toRadixString(16),
            'background': _themeCustomization.backgroundColor.value
                .toRadixString(16),
            'text': _themeCustomization.textColor.value.toRadixString(16),
          },
