  ...
  void _exportData(BuildContext context) {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: const Text('Voulez-vous exporter toutes vos cartes de visite ?'),
        actions: [
          TextButton(
            onPressed: () => Navigator.pop(context),
  ...
  void _importData(BuildContext context) {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: const Text('Voulez-vous importer des cartes depuis une sauvegarde ?'),
        actions: [
          TextButton(
            onPressed: () => Navigator.pop(context),
            child: const Text('Annuler'),
  ...
  void _clearCache(BuildContext context) {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: const Text('Voulez-vous supprimer tous les fichiers temporaires ?'),
        actions: [
          TextButton(
            onPressed: () => Navigator.pop(context),
            child: const Text('Annuler'),
  ...
  void _resetSettings(BuildContext context) {
    showDialog(
      ...
      builder: (dialogContext) => AlertDialog(
        ...
        content: const Text('Voulez-vous réinitialiser tous les paramètres aux valeurs par défaut ?'),
        actions: [
          TextButton(
