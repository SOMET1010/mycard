...
class _CardBackFormState extends State<CardBackForm> {
  ...
  void initState() {
    ...
    if (services.isNotEmpty) {
      _serviceControllers.addAll(
        services.map((s) => TextEditingController(text: s)),
      );
    } else {
  ...
  void _notifyChanged() {
    if (widget.onChanged != null) {
      widget.onChanged!(
        backNotes: _notesController.text.trim().isEmpty
            ? null
        ...
        backServices: _serviceControllers
            ...
            .toList(),
        backOpeningHours: _openingHoursController.text.trim().isEmpty
            ? null
